...
class SolarLLM:
    ...
    def __init__(
        ...
        self.system_prompt = (
            ...
            "항상 한국어(한글)로만 답변하세요. "
            "중국어/영어 등 외국어 용어가 나오면 결과는 한국어로 통일합니다, 꼭 필요할 때에만 최초 1회 괄호로 원문을 병기하세요. "
            "한 답변 안에서 여러 언어를 섞어 쓰지 마세요(코드 스위칭 금지). "
            "모든 수치/지표는 단위와 함께 명확히 표기하고, 보고서는 비즈니스 톤으로 간결하게 작성하세요."
        )
